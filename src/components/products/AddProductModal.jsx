...
const AddProductModal = ({ isOpen, onClose }) => {
  ...
  const handleSubmit = (e) => {
    ...
    const newProduct = {
      ...
      image: formData.image || 'https://placehold.co/400x300/e2e8f0/64748b?text=No+Image' // default fallback image
    };
    
    dispatch(addProduct(newProduct));
    setFormData({ name: '', price: '', status: 'Available', image: '' });
    onClose();
  };
          ...
          >
            <div className="bg-white rounded-2xl shadow-xl w-full max-w-md pointer-events-auto overflow-hidden">
              ...
              <form onSubmit={handleSubmit} className="p-6 space-y-4">
                ...
                <div>
                  <label htmlFor="product-image" className="block text-sm font-medium text-gray-700 mb-1">Image URL (Optional)</label>
                  <input
                    id="product-image"
                    type="url"
                    className="input-field"
